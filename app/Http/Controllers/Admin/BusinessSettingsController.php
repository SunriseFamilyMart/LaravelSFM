...
class BusinessSettingsController extends Controller
{
    ...
    public function businessSettingsIndex(): View|Factory|Application
    {
        ...
        // Get all saved business settings
        $savedCountry = Helpers::get_business_settings('country');
        $timeZone = Helpers::get_business_settings('time_zone');
        $timeFormat = Helpers::get_business_settings('time_format');
        $currency = Helpers::get_business_settings('currency');
        $decimalPointSettings = Helpers::get_business_settings('decimal_point_settings');
        $footerText = Helpers::get_business_settings('footer_text');
        $paginationLimit = Helpers::get_business_settings('pagination_limit');
        ...
        $address = Helpers::get_business_settings('address');
        $partialPaymentCombineWith = Helpers::get_business_settings('partial_payment_combine_with');
    ...
    public function maintenanceModeSetup(Request $request): RedirectResponse
    {
        ...
        $this->businessSettings->updateOrInsert(
