        ...
        <div class="page-header">
            <div class="media align-items-center">
                ...
                <div class="media-body pl-3">
                    <h1 class="page-header-title mb-1">{{ translate('sale') }} {{ translate('report') }}
                        {{ translate('overview') }}</h1>
                    <div>
                    ...
                    <div class="w-100 pt-3">
                        <form class="w-100">
                            <div class="row g-3 g-sm-4 g-md-3 g-lg-4">
                                <div class="col-sm-6 col-md-4 col-lg-2">
                                    <select class="custom-select custom-select-sm text-capitalize min-h-45px"
                                        ...
                                        <option disabled selected>--- {{ translate('select') }} {{ translate('branch') }}
                                            ---</option>
                                        <option value="all"
                                            {{ is_null($branchId) || $branchId == 'all' ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-6 col-md-12 col-lg-4 __btn-row">
                                    <a href="{{ route('admin.report.sales.export') }}"
                                        class="btn w-100 btn-success min-h-45px">
                                        <i class="tio-file-text"></i> {{ translate('Export to Excel') }}
                                    </a>
                                    {{-- <a href="{{ route('admin.report.sales.export') }}" 
   target="_blank"
   class="btn w-100 btn-success min-h-45px">
   <i class="tio-file-text"></i> {{ translate('View Excel Sheet') }}
</a> --}}
                                    ...
                                    <div class="col-sm-4">
                                        <div class="order--card h-100">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <span class="card-title text-success"
                                                    id="order_amount">{{ $totalSold }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <table class="table table-borderless table-align-middle">
                        ...
                        <tbody>
                            ...
                            @foreach ($orderDetails as $key => $detail)
                                ...
                                $product = is_string($detail->product_details) ? json_decode($detail->product_details, true) : $detail->product_details;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.product.view', [$product['id']]) }}" target="_blank"
                                            ...
                                            <img
                                                src="{{ $detail->product ? $detail->product->identityImageFullPath[0] : asset('public/assets/admin/img/160x160/2.png') }}">
