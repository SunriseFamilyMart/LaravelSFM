...
@section('title', translate('Create Purchase'))
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="mb-0 page-header-title">
                ...
                <span>{{ translate('Create New Purchase') }}</span>
            </h1>
        </div>
        ...
        <form action="{{ route('admin.purchase.store') }}" method="POST" id="purchaseForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="purchased_by" class="form-control" value="{{ auth()->user()->f_name ?? '' }} {{ auth()->user()->l_name ?? '' }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h5 class="mb-0">{{ translate('Initial Payment (Optional)') }}</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="initial_payment_amount" class="form-control" step="0.01" min="0">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ translate('Payment Date') }}</label>
                                <input type="date" name="initial_payment_date" class="form-control" value="{{ date('Y-m-d') }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>{{ translate('Payment Mode') }}</label>
                                <select name="initial_payment_mode" class="form-control">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="initial_payment_reference" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <button type="submit" class="btn btn-primary">
                        <i class="tio-save"></i> {{ translate('Create Purchase') }}
                    </button>
            ...
            <div class="item-row" id="item-${itemCount}">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" name="items[${itemCount}][quantity]" class="form-control" min="1" value="1" required onchange="calculateLineTotal(${itemCount})">
                    </div>
                    <div class="col-md-2">
                        <label>${translate('Unit Price')} <span class="text-danger">*</span></label>
                        <input type="number" name="items[${itemCount}][unit_price]" id="unit_price_${itemCount}" class="form-control" step="0.01" min="0" required onchange="calculateLineTotal(${itemCount})">
                    </div>
                    <div class="col-md-2">
                        <label>${translate('GST %')}</label>
                        <input type="number" name="items[${itemCount}][gst_percent]" class="form-control" step="0.01" min="0" max="100" value="0" onchange="calculateLineTotal(${itemCount})">
                    </div>
                    <div class="col-md-1">
