                            ...
                            <div id="english-form">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name[]" value="{{ $product['name'] }}"
                                        class="form-control" placeholder="{{ translate('New Product') }}" required>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" step="0.01"
                                        value="{{ $product['capacity'] }}" name="capacity" class="form-control"
                        ...
                        <div class="product--coba">
                            <div class="row g-2" id="coba">
                                @if (!empty(json_decode($product['image'], true)))
                                    @foreach ($product->identityImageFullPath as $identification_image)
                                        <div class="spartan_item_wrapper position-relative">
                                            <img class="img-150 border rounded p-3" src="{{ $identification_image }}"
                                                alt="{{ translate('identity_image') }}">
                                            <a href="{{ route('admin.product.remove-image', [$product['id'], basename($identification_image)]) }}"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" value="{{ $product['price'] }}" min="0"
                                            max="100000000" name="price" class="form-control" step="any"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" min="0" max="100000000"
                                            value="{{ $product['total_stock'] }}" name="total_stock"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" min="0" value="{{ $product['discount'] }}"
                                            max="100000" name="discount" class="form-control" step="any"
                                            placeholder="{{ translate('Ex : 100') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
    ...
    <script>
        ...
        $(document).ready(function() {
            setTimeout(function() {
                ...
                let sub_sub_category = '{{ count($productCategory) >= 3 ? $productCategory[2]->id : '' }}';
