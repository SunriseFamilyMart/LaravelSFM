    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{ asset('public/assets/admin/img/messages.png') }}" class="w--24"
                        alt="{{ translate('message') }}">
                </span>
                <span>{{ translate('Messages') }} <span class="badge badge-soft-primary ml-2"
                        id="conversation_count"></span></span>
            </h1>
        </div>
        ...
        <div class="row g-0">
                    ...
                    <div class="card-header border-0 px-0 mx-20px">
                        <div class="conv-open-user w-100">
                            <img class="w-47px" src="{{ auth('admin')->user()->imageFullPath }}"
                                alt="{{ translate('admin') }}">
                            <div class="info">
                                <h6 class="subtitle mb-0">{{ auth('admin')->user()->f_name }}
                                    {{ auth('admin')->user()->l_name }}</h6>
                    ...
                    <div class="card-body pt-0 px-0">
                        <div class="input-group-overlay input-group-sm mb-3 mx-20px">
                            <input placeholder="{{ translate('Search user') }}"
                                class="cz-filter-search form-control form-control-sm appended-form-control" type="text"
                                id="search-conversation-user" autocomplete="off">
                        </div>
                                    ...
                                    @if (isset($user))
                                        ...
                                        <div class="sidebar_primary_div customer-list view-conversation-details {{ $unchecked != 0 ? 'conv-active' : '' }}"
                                            ...
                                            <div class="conv-open-user w-100">
                                                ...
                                                <div class="info">
                                                    <h6 class="subtitle mb-0 sidebar_name chat-count">
                                                        {{ $user['f_name'] . ' ' . $user['l_name'] }}</h6>
            ...
            <div class="col-md-8 col-xxl-9 pl-0 view-conversion" id="view-conversation">
                <div
                    class="h-100 d-flex justify-content-center align-items-center card __shadow rounded-left-0 py-5 py-md-0 text-center">
                    <img src="{{ asset('/public/assets/admin/img/view-conv.png') }}" class="mw-100"
                        alt="{{ translate('image') }}">
                    <div>
