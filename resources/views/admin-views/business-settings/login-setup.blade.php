...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="col-12">
            <div class="card">
                <form id="login-setup-form" action="{{ route('admin.business-settings.store.login-setup-update') }}"
                    method="post">
                    @csrf
                    <div class="p-3 border-bottom">
                        <h4 class="mb-0">{{ translate('Setup Login Option') }}</h4>
                        <p class="mb-0">{{ translate('The option you select customer will have the to option to login') }}
                        </p>
                    </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb-2">
                                        <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                            ...
                                            <input name="apple" type="checkbox"
                                                {{ $socialMediaLoginOptions->apple == 1 ? 'checked' : '' }} id="apple">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6 mb-2">
                                        <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                            ...
                                            <input name="email_verification" type="checkbox"
                                                {{ $emailVerification == 1 ? 'checked' : '' }} id="email-verification">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 mb-2">
                                        <div class="form-control d-flex justify-content-between align-items-center gap-3">
                                            ...
                                            <input class="" name="phone_verification" type="checkbox"
                                                {{ $phoneVerification == 1 ? 'checked' : '' }} id="phone-verification">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        <div>
                            <img src="{{ asset('public/assets/admin/img/sms-img.png') }}"
                                alt="{{ translate('image') }}">
                        </div>
                        <div class="py-4">
                            <h5 class="modal-title" id="smsConfigModalLabel">
                                {{ translate('Set Up SMS Configuration/Firebase OTP Verification First') }}</h5>
                        </div>
                        <p>{{ translate('It looks like your SMS configuration is not set up yet. To enable the OTP system, please set up the SMS configuration/Firebase OTP Verification first.') }}
                        </p>
                    </div>
                    <div class="text text-center mb-5">
                        <a href="{{ route('admin.business-settings.web-app.sms-module') }}" target="_blank"
                            class="btn btn-primary">{{ translate('Go to SMS Configuration') }}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <div class="py-4">
                            <h5 class="modal-title" id="socialMediaConfigModalLabel">
                                {{ translate('Set Up Apple Configuration First') }}</h5>
                        </div>
                    ...
                    <div class="text text-center mb-5">
                        <a href="{{ route('admin.business-settings.web-app.third-party.social-media-login') }}"
                            target="_blank" class="btn btn-primary">{{ translate('Go to Apple Configuration') }}</a>
                    </div>
                </div>
            </div>
        </div>
