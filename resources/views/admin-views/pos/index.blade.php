                            ...
                            <div class="w-100">
                                <div class="d-flex flex-wrap flex-row py-2 add--customer-btn">
                                    <select id='customer' name="customer_id"
                                        ...
                                        <option value="" selected disabled>{{ translate('select customer') }}
                                        </option>
                                        @foreach ($users as $user)
                                            <option value="{{ $user['id'] }}"
                                                {{ session('customer_id') == $user['id'] ? 'selected' : '' }}>
                    ...
                    <form id='delivery_address_store'>
                        ...
                        <div class="col-md-12 mt-2">
                            <div class="btn--container justify-content-end">
                                <button class="btn btn-sm btn--primary w-100 delivery-address-update-button"
    ...
    <script>
        ...
        function store_key(key, value) {
            ...
            $.post({
                ...
                success: function(data) {
                    key = key == 'customer_id' ? "{{ translate('customer_id') }}" : (key == 'branch_id' ?
                        "{{ translate('branch_id') }}" : '');
