                        ...
                        <tbody id="set-rows">
                            @foreach ($orders as $key => $order)
                                <tr class="status-{{ $order['order_status'] }} class-all">
                                    ...
                                    <td>
                                        <label
                                            class="badge badge-soft-primary">{{ $order->branch ? $order->branch->name : translate('Branch deleted!') }}</label>
                                    </td>
                                    <td>
                                        <div class="mw-85">
                                            <div>
                                                <?php
                                                $vatStatus = optional($order->details->first())->vat_status;
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            ...
                                            <button class="action-btn btn-outline-primary-2 print-invoice-btn"
