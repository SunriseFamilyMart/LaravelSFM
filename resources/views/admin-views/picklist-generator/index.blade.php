        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="filter-sidebar mb-3">
                    ...
                    <form action="{{ route('admin.picklist-generator.index') }}" method="GET">
                        ...
                        <div class="form-group">
                            <label class="input-label">{{ translate('Branch/Store') }}</label>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.picklist-generator.index') }}" class="btn btn-secondary">
                                <i class="tio-clear"></i>
                            </a>
                        </div>
                    </form>
                    ...
                    <div class="d-grid gap-2">
                        <a href="{{ route('admin.picklist-generator.export-pdf', request()->all()) }}" 
                           class="btn btn-danger btn-block">
                            <i class="tio-download"></i> {{ translate('Download PDF') }}
                        </a>
                        <a href="{{ route('admin.picklist-generator.export-excel', request()->all()) }}" 
