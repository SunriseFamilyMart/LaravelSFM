...
<body>
    ...
    <div style="padding:20px;">
        ...
        <table width="100%">
            <tr>
                <td>
                    <h2 style="margin:0;">GST CREDIT NOTE</h2>
                    <strong>Credit Note No:</strong> {{ $creditNote->credit_note_no }}<br>
                    <strong>Date:</strong> {{ date('d M Y h:i A', strtotime($creditNote->created_at)) }}<br>
                    <strong>Original Order:</strong> #{{ $creditNote->order->id }}<br>
                    <strong>Reason:</strong> {{ ucfirst(str_replace('_', ' ', $creditNote->reason)) }}
                </td>
                <td align="right">
            ...
            <tbody>
                @foreach ($creditNote->items as $item)
                    @php
                        ...
                        // Get GST amount from item (already stored)
                    ...
                    <tr>
                        ...
                        <td align="center">{{ $item->gst_percent ?? 5 }}%</td>
