    ...
    <a class="nav-link" href="{{ route('admin.purchase.index') }}" title="Purchase Management">
        ...
        <span class="text-truncate">Purchase Management</span>
                                        ...
                                        <a class="nav-link" href="{{ route('admin.orders.list', ['all']) }}"
                                            ...
                                            <span class="text-truncate sidebar--badge-container">
                                                ...
                                                <span class="badge badge-info badge-pill ml-1">
                                                    ...
                                                    {{ \App\Model\Order::whereNotNull('id')->count() }}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    style="display: {{ Request::is('admin/delivery-details*') ? 'block' : 'none' }}">
                                    <li
                                        class="nav-item {{ Request::is('admin/delivery-details/list') ? 'active' : '' }}">
                                        <a class="nav-link" href="{{ route('admin.delivery-details.list') }}"
                                            title="{{ translate('All Deliveries') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate sidebar--badge-container">
                                                <span>{{ translate('All Deliveries') }}</span>
                                            </span>
                                        </a>
                                    </li>
                                    <li
                                        class="nav-item {{ Request::is('admin/delivery-details/pending') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.delivery-details.status', ['pending']) }}"
                                            title="{{ translate('Pending Deliveries') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate sidebar--badge-container">
                                                <span>{{ translate('Pending') }}</span>
                                            </span>
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/delivery-details/completed') ? 'active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('admin.delivery-details.status', ['completed']) }}"
                                            title="{{ translate('Completed Deliveries') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate sidebar--badge-container">
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['product_management']))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/product/bulk-export-index') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/product/limited-stock') ? 'active' : '' }}">
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['promotion_management']))
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.banner.add-new') }}" title="{{ translate('banner') }}">
                            ...
                            {{-- <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.coupon.add-new') }}" title="{{ translate('coupons') }}">
                                    <i class="tio-gift nav-icon"></i>
                                    <span
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/offer*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                            ...
                            {{--      <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/discount*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['support_management']))
                            ...
                            {{-- <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.message.list') }}" title="{{ translate('messages') }}">
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/message*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.message.sales.chats.index') }}"
                                    title="{{ translate('messages') }}">
                                    <i class="tio-messages nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ translate('Sales Person Chat') }}
                                    </span>
                                </a>
                            </li>
                        @endif
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['report_management']))
                            ...
                            <li
                                ...
                                <a class="nav-link " href="{{ route('admin.report.earning') }}"
                                    ...
                                    <span class="text-truncate">{{ translate('earning') }}
                                        {{ translate('report') }}</span>
                                </a>
                            </li>

                            {{--  <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/report/expense') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.report.expense') }}"
                                    title="{{ translate('expense') }} {{ translate('report') }}">
                                    <span class="tio-chart-bar-4 nav-icon"></span>
                                    <span class="text-truncate">{{ translate('expense') }}
                                        {{ translate('report') }}</span>
                                </a>
                            </li> --}}

                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/analytics*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/analytics/keyword-search') ? 'active' : '' }}">
                                        <a class="nav-link "
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/analytics/customer-search') ? 'active' : '' }}">
                                        <a class="nav-link "
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['user_management']))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/stores') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.stores.index') }}" title="{{ translate('Stores') }}">
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/roles-access') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.roles-access.index') }}"
                                    title="{{ translate('Role Access') }}">
                                    <i class="tio-lock nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ translate('Role Access') }}
                                    </span>
                                </a>
                            </li>

                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/sales-person') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('admin.sales-person.index') }}"
                                    title="{{ translate('Sales Person') }}">
                                    <i class="tio-user-add nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{ translate('Sales Person') }}
                                    </span>
                                </a>
                            </li>

                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/inventories') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        @if (Helpers::module_permission_check(MANAGEMENT_SECTION['system_management']))
                            ...
                            <li
                                ...
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="{{ translate('Branch Setup') }}">
                                    <i class="tio-shop nav-icon"></i>
                                    <span
                            ...
                            <li
                                ...
                                Request::is('admin/business-settings/web-app/sms-module*')
                                    ? 'active'
                                    : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:" title="{{ translate('Branch Setup') }}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    Request::is('admin/business-settings/web-app/sms-module*')
                                        ...
                                        : 'none' }}">
                                    <li
                                        class="nav-item {{ Request::is('admin/business-settings/web-app/payment-method') ||
                                        Request::is('admin/business-settings/web-app/third-party/fcm*') ||
                                        Request::is('admin/business-settings/web-app/third-party*') ||
                                        Request::is('admin/business-settings/web-app/mail-config*') ||
                                        Request::is('admin/business-settings/web-app/sms-module*')
                                    ...
                                    {{-- <li
                                        class="nav-item {{ Request::is('admin/business-settings/web-app/third-party/offline*') ? 'active' : '' }}">
                                        <a class="nav-link "
                                    ...
                                    <li
                                        ...
                                        <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                            href="javascript:" title="{{ translate('Pages & Media') }}">
                                            ...
                                            @foreach ($routes as $route)
                                                <li
                                                    ...
                                                    <a class="js-navbar-vertical-aside-menu-link nav-link "
                                                        ...
                                                        <span class="tio-circle nav-indicator-icon"></span>
                                                        <span
                                                            class="text-truncate">{{ translate($route['name']) }}</span>
                                                    </a>
                                                </li>
                                            @endforeach
                                        @endforeach
